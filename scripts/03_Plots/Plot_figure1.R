...
## For panel a, b, c and d : Run scripts "scripts/02_exploration/01_accumulation_curve.R"  
#                                         "scripts/02_exploration/01b_accumulation_curve_RLS.R"
## Or load Rdata :
...
## For panel e : Run script "scripts/02_exploration/13_prediction_family_species_richness.R"
## Or load Rdata :
load("Rdata/all_predictions_motus_species.rdata")

## For panel f : Run scripts "scripts/02_exploration/05b_family_presence_proportions.R"
#                             "scripts/02_exploration/10_proportion_motus_seuil_similarite.R"
## Or load Rdata :
...
ggsave(Fig1, "outputs/Figures papier/Figure1.png", width = 7.5, height = 7.5)
