...
## Plot panel a (or run script "scripts/02_exploration/09b_dominance_motus_ranks_upset.R")
#________________________________________________________________________________________________________________________________
...
## Run script "scripts/02_exploration/06a_MOTUs_diversity_partitioning.R"
## Or load Rdata :
...
ggsave(Fig3, "outputs/Figures papier/figure3b.png", dpi=500)
