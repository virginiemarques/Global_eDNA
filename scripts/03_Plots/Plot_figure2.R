...
## For panel a : Run scripts "scripts/02_exploration/04_nb_motu_family_site_station.R"  
## Or load Rdata :
...
## For panel b : Run scripts "scripts/02_exploration/05b_family_presence_proportions.R"
#                             "scripts/02_exploration/05c_random_proportion_families.R"
## Or load Rdata :
...
ggsave(Fig2, "outputs/Figures papier/Figure2.png", width = 7.5, height = 8, dpi = 300)
