...
ggsave("outputs/03_accumulation_curves/all_family_20_accumulation_curve_no_scale.png", width=8, height=8)
...
ggsave("outputs/03_accumulation_curves/all_family_20_accumulation_curve_scaled.png", width=8, height=8)
...
# Export 
write.csv(asymptote_fam, "outputs/03_accumulation_curves/table_asymptote_family10.csv", row.names = F)
