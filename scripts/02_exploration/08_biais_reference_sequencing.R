...
# Save
ggsave("outputs/08_reference/biais_reference_families_5.png", width = 10, height=10)
...
# Save
ggsave("outputs/08_reference/biais_reference_families_less_5.png", width = 10, height=12)
...
# Save
ggsave("outputs/08_reference/biais_reference_resolution_sequencing.png", width = 15, height=12)
