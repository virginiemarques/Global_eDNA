...
# plot figure 4a edna
a <- ggplot(tab, aes(x=log10(n), y=log10(n_motus)))+
  ...
  theme(panel.grid.major = element_blank(), 
        ...
        plot.title = element_text(size=12, face = "bold"))+
  labs(x="log10(Number of stations)",y="log10(Number of MOTUs)")
...
# plot figure 4b rls
b <- ggplot(tab2, aes(x=log10(occ_RLS), y=log10(Freq)))+
  ...
  theme(panel.grid.major = element_blank(), 
        ...
        axis.title.x = element_text(size = 10, face = "bold"),
        plot.title = element_text(size=12, face = "bold"))+
  labs(x="log10(Number of transects)",y="log10(Number of species)")
